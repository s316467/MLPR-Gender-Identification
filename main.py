...
if __name__ == '__main__':
    ...
    model_evaluator.kfold_cross_validation(LogRegClf.LinearLogisticRegression(lbd, prior_weighted=True, prior=0.5),
                                           ...
                                           preproc='znorm',
                                           dimred=dim_red)
    ModelEvaluation.BinaryModelEvaluator().plot_lambda_minDCF_LinearLogisticRegression(DT=DT, LT=LT, k=3) # prev commented
    ...
    ModelEvaluation.BinaryModelEvaluator().plot_lambda_minDCF_QuadraticLogisticRegression(DT=DT, LT=LT, k=3) # prev commented
    ...
    ModelEvaluation.BinaryModelEvaluator().plot_histogramGMM(DT, LT) # prev commented
