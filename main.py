...
import os
# Mac 
# os.chdir("/Users/antonioferrigno/Dropbox (Politecnico Di Torino Studenti)/Corsi PoliTo/Semestre 2/Machine learning and pattern recognition/Project/poliTO-MLPR-Project-Rosso/src/")
# Windows
#os.chdir('c:/Users/tony0/Dropbox (Politecnico Di Torino Studenti)/Corsi PoliTo/Semestre 2/Machine learning and pattern recognition/Project/poliTO-MLPR-Project-Rosso/src/')
...
if __name__ == '__main__':
    ...
    # Evaluation.BinaryModelEvaluator().plot_histogramGMM(DT, LT) # prev commented
    ...
    for c in comp:
        ...
        _, mindcf = Evaluation.kfold_cross_validation(GMMClassifier.GMM(alpha=0.1, nComponents=c, psi=0.01, covType=cov), DT, LT, k=5, preproc='znorm',dimred=dim_red)
        ...
        print('R: GMM Classifier(%d components - %s cov)\nPreprocessing: zg\nDim. Reduction: %s\n' % (c, 'Full', dim_red))
        _, mindcf = Evaluation.kfold_cross_validation(GMMClassifier.GMM(alpha=0.1, nComponents=c, psi=0.01, covType=cov), DT, LT, k=5, preproc='zg',dimred=dim_red)
    ...
    # print('R: MVG-Tied Classifier\nPreprocessing: raw\nDim. Reduction: %s\n' % dim_red)
    # Evaluation.kfold_cross_validation(GauClf.TiedG(), DT, LT, k=5, preproc='raw', dimred=dim_red)
    
    
    # lbd = 10**-4 # best LLR model
    # print('R: Linear Logistic Regression\nPreprocessing: znorm\nDim. Reduction: %s\n' % dim_red)
    # Evaluation.kfold_cross_validation(LogRegClf.LinearLogisticRegression(lbd, prior_weighted=True, prior=0.5),
    #                                        DT,
    #                                        LT,
    #                                        k=5,
    #                                        preproc='znorm',
    ...
    # Evaluation.kfold_cross_validation(SVMClf.SVM(hparams, kernel='RBF'),
    #                                        DT,
    #                                        LT,
    #                                        k=5,
    #                                        preproc='znorm',
    ...
    # Evaluation.kfold_cross_validation(SVMClf.SVM(hparams),
    #                                        DT,
    #                                        LT,
    #                                        k=5,
    #                                        preproc='znorm',
    ...
    # Evaluation.kfold_cross_validation(GMMClassifier.GMM(alpha=0.1, nComponents=nComponents, psi=0.01, covType=cov),
    #                                        DT,
    #                                        LT,
    #                                        k=5,
    #                                        preproc='znorm',
    ...
    # print('R: MVG-Tied Classifier\nPreprocessing: raw\nDim. Reduction: %s\n' % dim_red)
    # Evaluation.kfold_cross_validation(GauClf.TiedG(), DT, LT, k=5, preproc='raw', dimred=dim_red, calibrated = True)
    ...
    """
    fig = plt.figure()
    Evaluation.plotDET(plt, scores_TiedGaussian, LE)
    Evaluation.plotDET(plt, scores_LLR, LE)
    Evaluation.plotDET(plt, scores_LinearSVM, LE)
    Evaluation.plotDET(plt, scores_RBFSVM, LE)
    Evaluation.plotDET(plt, scores_TiedGMM, LE)
    fig.legend(['Tied Gaussian', 'LLR', 'Linear SVM', 'RBF SVM' ,'Tied GMM(4 components)'])
